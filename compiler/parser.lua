...
local Const = require("lunar.compiler.ast.const")
...
local typeData = require("lunar.compiler.ast.parsed.type_data")
local DataOption = typeData.DataOption
local TFunc = require("lunar.compiler.ast.parsed.type_func").TFunc
local TNamed = require("lunar.compiler.ast.parsed.type_named").TNamed
local TParameter = require("lunar.compiler.ast.parsed.type_parameter").TParameter
local TRecord = require("lunar.compiler.ast.parsed.type_record").TRecord
local TTuple = require("lunar.compiler.ast.parsed.type_tuple").TTuple
local TUnit = require("lunar.compiler.ast.parsed.type_unit").TUnit

local PAlias = require("lunar.compiler.ast.parsed.pattern_alias").PAlias
local PAny = require("lunar.compiler.ast.parsed.pattern_any").PAny
local PCons = require("lunar.compiler.ast.parsed.pattern_cons").PCons
local PConst = require("lunar.compiler.ast.parsed.pattern_const").PConst
local PList = require("lunar.compiler.ast.parsed.pattern_list").PList
local PNamed = require("lunar.compiler.ast.parsed.pattern_named").PNamed
local POption = require("lunar.compiler.ast.parsed.pattern_option").POption
local pRecordMod = require("lunar.compiler.ast.parsed.pattern_record")
local PRecord = pRecordMod.PRecord
local PRecordField = pRecordMod.PRecordField
local PTuple = require("lunar.compiler.ast.parsed.pattern_tuple").PTuple

local Access = require("lunar.compiler.ast.parsed.expression_access").Access
local Accessor = require("lunar.compiler.ast.parsed.expression_accessor").Accessor
local Apply = require("lunar.compiler.ast.parsed.expression_apply").Apply
local binOpMod = require("lunar.compiler.ast.parsed.expression_binOp")
local BinOp = binOpMod.BinOp
local BinOpItem = binOpMod.BinOpItem
local Call = require("lunar.compiler.ast.parsed.expression_call").Call
local ConstExpr = require("lunar.compiler.ast.parsed.expression_const").Const
local Function = require("lunar.compiler.ast.parsed.expression_function").Function
local If = require("lunar.compiler.ast.parsed.expression_if").If
local InfixVar = require("lunar.compiler.ast.parsed.expression_infixVar").InfixVar
local Lambda = require("lunar.compiler.ast.parsed.expression_lambda").Lambda
local Let = require("lunar.compiler.ast.parsed.expression_let").Let
local List = require("lunar.compiler.ast.parsed.expression_list").List
local Negate = require("lunar.compiler.ast.parsed.expression_negate").Negate
local recordExprMod = require("lunar.compiler.ast.parsed.expression_record")
local Record = recordExprMod.Record
local RecordField = recordExprMod.RecordField
local selectMod = require("lunar.compiler.ast.parsed.expression_select")
local Select = selectMod.Select
local SelectCase = selectMod.SelectCase
local Tuple = require("lunar.compiler.ast.parsed.expression_tuple").Tuple
local Update = require("lunar.compiler.ast.parsed.expression_update").Update
local Var = require("lunar.compiler.ast.parsed.expression_var").Var

local dataTypeMod = require("lunar.compiler.ast.parsed.dataType")
...
local Module = require("lunar.compiler.ast.parsed.module").Module
